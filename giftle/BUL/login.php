...
<div class="formulaire">
        <div class="div1">
            ...
            <form action="" method="post">
                <div>
                   <div><label for="name">име</label></div> 
                    <input class="input" type="text" placeholder="Пример: Стив"  name="user_name" value="<?php echo isset($_POST['user_name']) ? $_POST['user_name'] : '' ?>">
                </div>
                <div>
                    <div><label for="mail">Електронна поща</label></div>
                    <input  class="input" type="email" placeholder="Име@gmail.com" name="user_mail" value="<?php echo isset($_POST['user_mail']) ? $_POST['user_mail'] : '' ?>">
                </div>
                <div>
                   <div><label for="msg">парола</label></div> 
                   <input class="input" type="password" placeholder="********"  name="password" value="<?php echo isset($_POST['password']) ? $_POST['password'] : '' ?>">
                </div>
                <div><label for="msg">Потвърждение на парола</label></div> 
                <input class="input" type="password" placeholder="********"  name="password_con" value="<?php echo isset($_POST['password_con']) ? $_POST['password_con'] : '' ?>">
                <input class="greenButton" type="submit" value="регистрирам" name="register">
                <?php
            ...
            <div class="div2">
                <form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="post">
                    ...
                    <div class="margin-bottom"></div>
                    <div >
                        <div><label id="mail" for="mail">Електронна поща</label></div>
                        <input  class="input" type="email" placeholder="Име@gmail.com" id="" name="user_mail" value="<?php echo isset($_POST['user_mail']) ? $_POST['user_mail'] : '' ?>">
                    </div>
                    <div>
                       <div><label for="msg">парола</label></div> 
                       <input class="input" type="password" placeholder="********"  name="password" value="<?php echo isset($_POST['password']) ? $_POST['password'] : '' ?>">
                    ...
                    <input class="greenButton" type="submit" name="login" value="Влизам">
                    <?php
                    ob_start();
