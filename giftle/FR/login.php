        ...
        <div class="div1">
            ...
            <form action="" method="post">
                <div>
                   <div><label for="name">Nom </label></div> 
                    <input class="input" type="text" placeholder="Exemple: Steve"  name="user_name" value="<?php echo isset($_POST['user_name']) ? $_POST['user_name'] : '' ?>">
                </div>
                <div>
            ...
            <div class="div2">
                <form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="post">
                    ...
                    <input class="greenButton" type="submit" name="login" value="Se connecter">
                    <?php
                    ob_start();
