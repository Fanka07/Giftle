   ...
   <link href="https://fonts.googleapis.com/css2?family=Montserrat&display=swap" rel="stylesheet">
    ...
    <nav >
        <div class="navigation">
          ...
          <li> <a href="HowItWorks.php">Comment cela fonctionne-t-il ?</a></li>
          <li><a href="contact.php">Contact</a></li>
                 <!--  Dropdown -->
         <div class="dropdown">
            <li><a onclick="dropdownLanguages()" class="dropbtn">Languages<span id="triangle">&#9660;</span> </a></li>
            <div id="myDropdown" class="dropdown-content">
            <a href="../EN/index.php">ANGLAIS</a>
              <a href="../FR/index.php">FRANCAIS</a>
              <a href="../BUL/index.php">BULGARIE</a>
            </div>
            </div>
